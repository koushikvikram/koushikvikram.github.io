...
- [☕ Distributed Databases Explained](https://quastor.substack.com/p/-distributed-databases-explained)
- [How Airbnb does Continuous Delivery](https://quastor.substack.com/p/how-airbnb-does-continuous-delivery)
- [How Clubhouse recommends Rooms](https://quastor.substack.com/p/how-clubhouse-recommends-rooms)
- [How Tinder streams video to 70 million users](https://quastor.substack.com/p/how-tinder-streams-video-to-70-million)
- [A One Person Startup's Tech Stack](https://quastor.substack.com/p/a-one-person-startups-tech-stack)
- [Serverless Testing, Part 2: SOLID Architecture for Lambda](https://walmsles.medium.com/serverless-testing-part-2-solid-architecture-for-lambda-febec28019c5)
- [How the BBC uses Serverless](https://blog.quastor.org/p/bbc-uses-serverless-24d1)
